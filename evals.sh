...
python3.8 main.py --dataloader_json JSONFiles/finales_convnext/ddr_convnext_aa/DDR_ --snf_train_custom --lr 0.015 --decay_lr 0.8  --patience 30 --epochs 200 --batch 512 --device 1 --dump ./runs_models/snf_convnext_f/aa/SNF_12_2.pth --loss_sensitive --loss_mode 3 --custom  0 1 2 5 8
